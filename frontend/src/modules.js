...
export const STATUS_BADGE = {
  ...
  'Đã tiếp nhận': 'sc-badge-info', 'Chờ xử lý': 'sc-badge-warning', 'Đã nhập kho': 'sc-badge-success',
...
export const DT = {
  ...
  'Framework Contract': {
    ...
    listColumns: [
      ...
      { key: 'contract_number', label: 'Số HĐ', type: 'code' },
      { key: 'name', label: 'Mã HĐ', type: 'code' },
  ...
  'Release Order': {
    ...
    listColumns: [
      ...
      { key: 'name', label: 'Mã RO', type: 'code' },
      { key: 'release_date', label: 'Ngày lệnh', type: 'date' },
      { key: 'total_amount', label: 'Tổng', type: 'currency', align: 'right' },
      { key: 'framework_contract', label: 'HĐ khung', type: 'code' },
      { key: 'status', label: 'Trạng thái', type: 'badge', badgeMap: STATUS_BADGE },
    ],
    listFields: ['name', 'framework_contract', 'supplier', 'supplier_name', 'release_date',
                  'total_amount', 'status', 'docstatus'],
  },
  ...
  'SC Material Request': {
    ...
    listColumns: [
      { key: 'name', label: 'Mã MR', type: 'code' },
  ...
  // === M3 ===
  'SC Purchase Receipt': {
    module: 'm3', label: 'Phiếu tiếp nhận tạm', icon: 'package-check',
    listColumns: [
      { key: 'supplier', displayKey: 'supplier_name', label: 'NCC' },
      { key: 'name', label: 'Mã PR', type: 'code' },
      { key: 'posting_date', label: 'Ngày', type: 'date' },
      { key: 'purchase_order', label: 'Đơn mua', type: 'code' },
      { key: 'is_return', label: 'Trả', type: 'check' },
      { key: 'qc_status', label: 'QC', type: 'badge', badgeMap: STATUS_BADGE },
      { key: 'receipt_status', label: 'Nhập kho', type: 'badge', badgeMap: STATUS_BADGE },
    ],
    listFields: ['name', 'posting_date', 'supplier', 'supplier_name', 'purchase_order',
                  'is_return', 'qc_status', 'receipt_status', 'docstatus'],
  ...
  'SC Stock Ledger Entry': {
    ...
    listColumns: [
      ...
      { key: 'voucher_no', label: 'Số CT', type: 'code' },
      { key: 'name', label: 'SLE', type: 'code' },
    ],
    listFields: ['name', 'posting_date', 'item', 'item_name', 'warehouse', 'batch', 'qty_change',
  ...
  'SC Batch': {
    ...
    listFields: ['name', 'barcode', 'item', 'item_name', 'supplier_batch_no', 'manufacturing_date',
                  'expiry_date', 'qc_status', 'blocked', 'supplier'],
  },
  ...
  'SC Transfer Request': {
    ...
    listColumns: [
      { key: 'name', label: 'Mã TR', type: 'code' },
  ...
  'SC Stock Entry': {
    ...
    listColumns: [
      { key: 'name', label: 'Mã SE', type: 'code' },
      { key: 'posting_date', label: 'Ngày', type: 'date' },
  ...
  'SC Customer': {
    ...
    listColumns: [
      ...
      { key: 'name', label: 'Mã KH', type: 'code' },
  ...
  'SC Sales Framework Contract': {
    ...
    listFields: ['name', 'customer', 'customer_name', 'contract_number', 'valid_from', 'valid_to',
                  'total_value', 'status', 'docstatus'],
  },
  'SC Sales Order': {
    module: 'm7', label: 'Đơn bán hàng', icon: 'clipboard-list',
    listColumns: [
      { key: 'customer', displayKey: 'customer_name', label: 'Khách hàng' },
      { key: 'name', label: 'Mã SO', type: 'code' },
    ...
    listFields: ['name', 'customer', 'customer_name', 'framework_contract', 'order_date', 'total_amount',
  ...
  'SC Delivery Note': {
    ...
    listColumns: [
      { key: 'customer', displayKey: 'customer_name', label: 'Khách hàng' },
      { key: 'name', label: 'Mã DN', type: 'code' },
      { key: 'delivery_date', label: 'Ngày giao', type: 'date' },
      { key: 'from_warehouse', label: 'Kho xuất' },
      { key: 'sales_order', label: 'Đơn bán', type: 'code' },
      { key: 'status', label: 'Trạng thái', type: 'badge', badgeMap: STATUS_BADGE },
    ],
    listFields: ['name', 'sales_order', 'customer', 'customer_name', 'from_warehouse', 'delivery_date',
                  'status', 'docstatus'],
  },
  'SC Acceptance Record': {
    ...
    listColumns: [
      { key: 'customer', displayKey: 'customer_name', label: 'Khách hàng' },
      { key: 'name', label: 'Mã BB', type: 'code' },
      { key: 'acceptance_date', label: 'Ngày nghiệm thu', type: 'date' },
      { key: 'accepted_by', label: 'Người nhận' },
      { key: 'delivery_note', label: 'Phiếu giao', type: 'code' },
      { key: 'status', label: 'Trạng thái', type: 'badge', badgeMap: STATUS_BADGE },
    ],
    listFields: ['name', 'delivery_note', 'customer', 'customer_name', 'acceptance_date', 'accepted_by',
                  'status', 'docstatus'],
  },
  'SC Sales Invoice': {
    ...
    listColumns: [
      { key: 'customer', displayKey: 'customer_name', label: 'Khách hàng' },
      { key: 'name', label: 'Mã SI', type: 'code' },
    ...
    listFields: ['name', 'customer', 'customer_name', 'delivery_note', 'invoice_date', 'grand_total',
  ...
  'SC Sales Receipt': {
    ...
    listColumns: [
      { key: 'customer', displayKey: 'customer_name', label: 'Khách hàng' },
      { key: 'name', label: 'Mã PT', type: 'code' },
      { key: 'receipt_date', label: 'Ngày thu', type: 'date' },
      { key: 'amount', label: 'Số tiền', type: 'currency', align: 'right' },
      { key: 'mode', label: 'Phương thức' },
      { key: 'sales_invoice', label: 'Hoá đơn', type: 'code' },
    ],
    // Trạng thái = docstatus (Nháp/Đã thu/Đã huỷ) — hiển thị ở màn chi tiết, không
    // có field `status` nên KHÔNG đưa vào listFields (tránh lỗi SQL 1054).
    listFields: ['name', 'customer', 'customer_name', 'sales_invoice', 'receipt_date',
                  'amount', 'mode', 'docstatus'],
  },
  ...
  'SC Purchase Invoice': {
    ...
    listColumns: [
      { key: 'supplier', displayKey: 'supplier_name', label: 'NCC' },
      { key: 'name', label: 'Mã PI', type: 'code' },
      { key: 'invoice_date', label: 'Ngày HD', type: 'date' },
      { key: 'grand_total', label: 'Tổng', type: 'currency', align: 'right' },
      { key: 'outstanding_amount', label: 'Còn lại', type: 'currency', align: 'right' },
      { key: 'purchase_receipt', label: 'Phiếu nhận', type: 'code' },
    ...
    listFields: ['name', 'invoice_date', 'supplier', 'supplier_name', 'purchase_receipt', 'grand_total',
  ...
  'SC Payment Entry': {
    ...
    listColumns: [
      { key: 'supplier', displayKey: 'supplier_name', label: 'NCC' },
      { key: 'name', label: 'Mã PE', type: 'code' },
      { key: 'payment_date', label: 'Ngày', type: 'date' },
      { key: 'amount', label: 'Số tiền', type: 'currency', align: 'right' },
      { key: 'payment_method', label: 'Phương thức' },
      { key: 'status', label: 'Trạng thái', type: 'badge', badgeMap: STATUS_BADGE },
    ],
    listFields: ['name', 'payment_date', 'supplier', 'supplier_name', 'amount', 'payment_method',
                  'status', 'docstatus'],
  },
  'SC GL Entry': {
    ...
    listColumns: [
      ...
      { key: 'voucher_no', label: 'Chứng từ', type: 'code' },
      { key: 'name', label: 'GL', type: 'code' },
    ],
  ...
  'SC Recall Notice': {
    ...
    listFields: ['name', 'recall_date', 'item', 'item_name', 'batch_no', 'severity', 'status',
  ...
  'SC Investigation Report': {
    ...
    listFields: ['name', 'investigation_date', 'investigation_type', 'item', 'item_name',
