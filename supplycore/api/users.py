...
ROLE_GUIDE: dict[str, dict] = {
    ...
    "SupplyCore Accountant": {
        ...
        "limits": [
            ...
            "Không tạo Đơn hàng bán (SO) / Phiếu giao hàng (DN), không kiểm kê",
        ],
        "modules": ["M8", "M1", "M7"],
        "danger_level": "medium",
    },
    "SupplyCore Executive": {
        ...
        "duties": [
            ...
            "Xem Dashboard KPI tổng hợp toàn công ty",
            "Đọc báo cáo điều hành (M11)",
        ],
        "limits": [
            "Không tạo phiếu nghiệp vụ trực tiếp",
            "Chỉ duyệt khi có recommendation từ Manager",
            "Không truy cập chi tiết Đơn hàng bán / Giao hàng (M7)",
        ],
        "modules": ["M1", "M2", "M11"],
        "danger_level": "medium",
    },
    "SupplyCore Purchaser": {
        "vn_name": "Cán bộ mua hàng & bán hàng",
        "scope": "M2 Lập kế hoạch & mua, đọc M1 hợp đồng, M7 Bán hàng & Bàn giao",
        "duties": [
            ...
            "Tạo Khách hàng (SC Customer), Hợp đồng khung bán (SFC), Đơn hàng bán "
            "(SO) và duyệt SO — M7 Bán hàng & Bàn giao",
        ],
        "limits": [
            "Không submit PO > ngưỡng giá trị (cần Manager)",
            "Không sửa Framework Contract đã duyệt",
            "Không tự xuất hóa đơn / thu tiền (M7 do Kế toán đảm nhiệm), không kiểm kê",
        ],
        "modules": ["M2", "M1", "M7"],
        "danger_level": "low",
    },
