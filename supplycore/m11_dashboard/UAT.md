...
|---|---|---|---|
| 1 | API get_executive_dashboard | PASS | stock_value=362087500.0, pending_pos=17, expiring=0, top=3 |
| 2 | API get_warehouse_dashboard | PASS | qty_total=3295.0, expiring=0, dr=8 |
| 3 | Tạo SC Alert Rule (UAT) | PASS | SC-AR-00759 |
