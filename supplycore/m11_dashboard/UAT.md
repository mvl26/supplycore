...
|---|---|---|---|
| 1 | API get_executive_dashboard | PASS | stock_value=459705200.0, pending_pos=22, expiring=0, top=3 |
| 2 | API get_warehouse_dashboard | PASS | qty_total=5480.0, expiring=0, dr=12 |
| 3 | Tạo SC Alert Rule (UAT) | PASS | SC-AR-01121 |
