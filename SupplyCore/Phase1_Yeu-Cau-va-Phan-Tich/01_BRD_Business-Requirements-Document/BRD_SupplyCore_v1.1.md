...
__Nội dung công việc__

__Deliverable__

__Thiết kế \(HOÀN THÀNH\)__

Tuần 1 tháng 5 \(01/05 – 07/05/2026\)

Hoàn thiện toàn bộ tài liệu thiết kế: BRD, URS, Use Case, As\-Is/To\-Be Process Flow, System Architecture, Database Design, Technical Spec, API, UI/UX Mockups

Bộ tài liệu Phase 1 & 2 đầy đủ

__Dev – Build 11 Modules__

Tuần 2–3 tháng 5 \(08/05 – 21/05/2026\)

IT phát triển và build đầy đủ 11 module: M1 Hợp đồng NCC, M2 Kế hoạch tồn kho, M3 Tiếp nhận QC, M4 WMS/PDA, M5 Lô/FEFO, M6 Luân chuyển, M7 Cấp phát BHYT, M8 Kế toán, M9 Kiểm kê, M10 Truy xuất, M11 Dashboard

Full 11 modules – code hoàn chỉnh, unit test pass

__Chạy thử & Tối ưu__

Tuần 4 tháng 5 \(22/05 – 31/05/2026\)

Deploy lên môi trường staging, UAT với người dùng thực tế tại bệnh viện, fix bug, tối ưu hiệu năng, đào tạo nhanh cho các nhóm người dùng chính, chuẩn bị go\-live

UAT sign\-off, Go\-live ready
...
__Chi tiết công việc__

__Người phụ trách__

Toàn bộ tài liệu Phase 1

Tuần 1

BRD, URS, Use Case, As\-Is, To\-Be – hoàn chỉnh và phê duyệt

BA Team

Tài liệu Phase 2 \(Thiết kế\)

Tuần 1

System Architecture, DB Design, Tech Spec, API Docs, Security Doc

Solution Architect

Thiết kế UI/UX \(Phase 3\)

Tuần 1

Mockups, Wireframes, Design System – đủ để IT bắt đầu dev
...
Hợp đồng NCC, Kế hoạch tồn kho, Tiếp nhận QC, Kế toán – build trên ERPNext standard \+ custom
...
WMS/PDA, Lô/FEFO, Luân chuyển nội bộ, Cấp phát \+ tích hợp BHYT N01\-N09
...
Kiểm kê đối soát, Truy xuất lô/recall, Dashboard & Cảnh báo điều hành
...
Deploy staging, kiểm thử với user thực tế, ghi nhận và fix toàn bộ bug priority P1/P2
...
Performance tuning: query optimization, caching, load test với 50\+ concurrent users
...
Đào tạo nhanh các nhóm người dùng, migrate dữ liệu đầu kỳ, go\-live chính thức cuối tháng 5
