...
BODY	**Vai trò:** Tất cả các vai trò đều có Dashboard và Trung tâm cảnh báo riêng theo chân dung — Quản trị Hệ thống, Trưởng phòng, Lãnh đạo, NV Mua & Bán hàng, Thủ kho, Kế toán, Kiểm định. Mọi vai trò được **xem và xử lý** cảnh báo (xác nhận, tạm ẩn, phân công); riêng **Người dùng cơ bản** chỉ được xem. Việc **cấu hình Quy tắc cảnh báo (SC Alert Rule)** chỉ dành cho **Quản trị Hệ thống** và **Trưởng phòng**.
...
OL	Dùng các bộ lọc ở góc trên phải để thu hẹp số liệu: ô **— Tất cả kho —** (lọc theo kho), ô **— Tất cả phòng ban —** (lọc theo phòng ban), và ô kỳ thời gian gồm **Hôm nay**, **Tuần này**, **Tháng này**, **Quý này**, **Năm nay**.
...
NOTE	Các thẻ lối tắt (quick-action) hiện ngay trên hàng KPI cũng đổi theo chân dung — ví dụ Thủ kho thấy **Xếp hàng lên kệ**, **Kiểm kê**, **Bản đồ kho**; Kế toán thấy **Hóa đơn mới**, **Phiếu thanh toán**, **Báo cáo tài chính**; NV Bán hàng thấy **Đơn hàng mới**, **Khách hàng**. Bấm thẻ để đi thẳng tới tác vụ đó.
H4	3.11.3.2	Xuất Snapshot PDF của Dashboard
OL	Trên trang Tổng quan, đặt sẵn kỳ thời gian và kho mong muốn (bộ lọc phòng ban không áp dụng cho bản snapshot).
